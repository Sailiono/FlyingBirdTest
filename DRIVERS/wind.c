...
//		resultP = SM3041_Data_FetchBaro();
		...
		windspeed = ((float)(*result) - SM3041_MINCOUNT)* (SM3041_PRESSURE_MAX - SM3041_PRESSURE_MIN)/ (SM3041_MAXCOUNT - SM3041_MINCOUNT) + SM3041_PRESSURE_MIN;//caculate corrected windpressure
		temperature = (float)(*(result+1))*200/2047 - 50;
